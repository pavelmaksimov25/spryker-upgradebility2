...
<head>
    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
        ...
        <div class="flex justify-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0" style="margin-top: 50px;">
            {{-- Shifty code --}}
            <p>Shiftcoded by {{{ fake()->name() }}} </p>
        </div>
        ...
        <div class="flex justify-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0" style="margin-top: 50px;">
            ...
            @php $ip = \App\Services\ShiftyService::getClientIp() @endphp
            <p>You are @if(\App\Services\ShiftyService::isPrivate($ip)) my creator. @else my guest.  @endif</p>
            <p>@if(\App\Services\ShiftyService::isIp($ip))  Your ip is {{ $ip }}. @else {{{ $ip }}} @endif</p>
        </div>
    </div>
</div>
</body>
